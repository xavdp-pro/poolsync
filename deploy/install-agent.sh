...
ssh "root@$HOST" "chown -R $USER_NAME:$USER_NAME /home/$USER_NAME/.config/poolsync /home/$USER_NAME/.local/share/poolsync /home/$USER_NAME/.local/share/applications/com.xavdp.poolsync.desktop /home/$USER_NAME/.config/systemd/user/poolsync-agent.service /home/$USER_NAME/.config/systemd/user/poolsync-watchdog.service /home/$USER_NAME/.config/systemd/user/poolsync-watchdog.timer /home/$USER_NAME/.local/bin/poolsync-agent-launch.sh /home/$USER_NAME/.local/bin/poolsync-logs /home/$USER_NAME/.local/bin/poolsync-watchdog.sh /home/$USER_NAME/.local/bin/write-image-clipboard.py && chmod 755 /home/$USER_NAME/.local/bin/poolsync-agent-launch.sh /home/$USER_NAME/.local/bin/poolsync-logs /home/$USER_NAME/.local/bin/poolsync-watchdog.sh /home/$USER_NAME/.local/bin/write-image-clipboard.py && chmod 644 /home/$USER_NAME/.local/share/poolsync/poolsync-tray.png /home/$USER_NAME/.local/share/applications/com.xavdp.poolsync.desktop"
...
ssh "root@$HOST" "su - $USER_NAME -c 'export XDG_RUNTIME_DIR=/run/user/$(id -u $USER_NAME); systemctl --user disable --now now3pool-agent.service 2>/dev/null || true; systemctl --user daemon-reload; systemctl --user enable --now poolsync-agent.service; systemctl --user enable --now poolsync-watchdog.timer; systemctl --user status poolsync-agent.service --no-pager | head -15'"
