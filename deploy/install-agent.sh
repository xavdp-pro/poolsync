...
ssh "root@$HOST" "chmod 755 /home/$USER_NAME/.local/bin/poolsync-session-start.sh /tmp/poolsync-enable-user.sh && chown $USER_NAME:$USER_NAME /home/$USER_NAME/.local/bin/poolsync-session-start.sh /tmp/poolsync-enable-user.sh && runuser -u $USER_NAME -- /tmp/poolsync-enable-user.sh $USER_NAME"
